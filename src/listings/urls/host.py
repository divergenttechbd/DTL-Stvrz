...
from listings.views.host import (
    ...
    HostListingHardDeleteAPIView, ManageSingleCoHostAssignmentView,
)
...
path(
        'manage-cohosts/<int:assignment_id>/',
        ManageSingleCoHostAssignmentView.as_view(),
        name='cohost_manage_single'
    ),
